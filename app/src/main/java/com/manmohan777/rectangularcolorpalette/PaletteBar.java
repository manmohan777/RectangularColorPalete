...
public class PaletteBar extends RelativeLayout {
    ...
    public static final int DEFAULT_COLOR_MARGIN_DP = 2;
...
//            new GradientDrawable(LR_ORIENTATION, new int[] { BROWN, RED }),
            ...
            new GradientDrawable(LR_ORIENTATION, new int[] { VIOLET, RED }),
    };
     ...
     */
    public void setColorChangingBorder(int colorMarginPx) {
...
//        }
    ...
    private OnTouchListener mTouchListener = new OnTouchListener() {
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            mCurrentColor = getColorFromCoordinates(x, y);
...
//            b = 0;
//        } else
            if (gradientIdx == 0) { // f00 to ff0
            r = 255;
            g = mantissa * 255;
            b = 0;
        } else if (gradientIdx == 1) { // ff0 to 0f0
            r = 255 - mantissa * 255;
            g = 255;
            b = 0;
        } else if (gradientIdx == 2) { // 0f0 to 0ff
            r = 0;
            g = 255;
            b = mantissa * 255;
        } else if (gradientIdx == 3) { // 0ff to 00f
            r = 0;
            g = 255 - mantissa * 255;
            b = 255;
        } else if (gradientIdx == 4) { // 00f to f0f
            r = mantissa * 255;
            g = 0;
            b = 255;
        }
        else if (gradientIdx >=5){
            r = 255;
            g= 0;
            b = 255 - mantissa * 255;
        }
...
//        }
    ...
    public void setPaletteBarListener(PaletteBarListener listener) {
        mListener = listener;
